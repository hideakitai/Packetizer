...
void setup()
{
...

    {
        ...
        if (p_in.data != p_out.data) Serial.println("test 1 failed!");
    ...
    }
    {
        ...
        if (p_in.data != p_out.data) Serial.println("test 2 failed!");
    ...
    }
    {
        ...
        if (p_in.data != p_out.data) Serial.println("test 3 failed!");
    ...
    }
    {
        ...
        if (p_in.data != p_out.data) Serial.println("test 4 failed!");
    ...
    }
    {
        ...
        if (p_in.data != p_out.data) Serial.println("test 5 failed!");
    ...
    }
    {
        ...
        if (p_in.data != p_out.data) Serial.println("test 6 failed!");
