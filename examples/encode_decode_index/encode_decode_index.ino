...
void setup() {
    ...
    {
        Packetizer::Packet p_in {0xCC, {0x00}};
    ...
    {
        Packetizer::Packet p_in {0xCC, {0x00, 0x00}};
        const auto& p_buff = Packetizer::encode(p_in.index, p_in.data.data(), p_in.data.size());
        const auto& p_out = Packetizer::decode(p_buff.data.data(), p_buff.data.size());
    ...
    {
        Packetizer::Packet p_in {0xCC, {0x11, 0x22, 0x00, 0x33}};
        const auto& p_buff = Packetizer::encode(p_in.index, p_in.data.data(), p_in.data.size());
        const auto& p_out = Packetizer::decode(p_buff.data.data(), p_buff.data.size());
    ...
    {
        Packetizer::Packet p_in {0xCC, {0x11, 0x22, 0x33, 0x44}};
        const auto& p_buff = Packetizer::encode(p_in.index, p_in.data.data(), p_in.data.size());
        const auto& p_out = Packetizer::decode(p_buff.data.data(), p_buff.data.size());
    ...
    {
        Packetizer::Packet p_in {0xCC, {0x11, 0x00, 0x00, 0x00}};
        const auto& p_buff = Packetizer::encode(p_in.index, p_in.data.data(), p_in.data.size());
        const auto& p_out = Packetizer::decode(p_buff.data.data(), p_buff.data.size());
    ...
    {
        Packetizer::Packet p_in {0xCC, {0xC0, 0xC1, 0xDA, 0xDB, 0xDC, 0xDD, 0xDE}};
        const auto& p_buff = Packetizer::encode(p_in.index, p_in.data.data(), p_in.data.size());
        const auto& p_out = Packetizer::decode(p_buff.data.data(), p_buff.data.size());
